...
var ws = new WebSocket('ws://127.0.0.1:' + location.port + '/webrepl/socket'),
...
var StackView = React.createClass({
    ...
    handleClick: function handleClick(i, level, parenti) {
        ...
        var idx = getoffset(i, parenti, level);
    ...
    valTreeView: function valTreeView(vals, level, parenti) {
        ...
        return vals.map(function (val, i) {
            var label = React.createElement(
                'span',
                { className: 'node', onClick: _this.handleClick.bind(_this, i) },
                val.what
            ); // /
            return React.createElement(
                TreeView,
                {
                    key: i,
                    nodeLabel: label,
                    collapsed: _this.state.collapsedNodes[getoffset(i, parenti, level)],
...
ReactDOM.render(React.createElement(StackView, null), document.getElementById('stack')); // /

prompt();

},{"jq-console":2,"react":160,"react-dom":3,"react-treeview":4}],2:[function(require,module,exports){
